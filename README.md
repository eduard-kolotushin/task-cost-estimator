...
| Группа | Переменные |
|--------|------------|
| **TaskTracker** | `TASKTRACKER_BASE_URL` (обязательно), `TASKTRACKER_TOKEN` и/или `TASKTRACKER_BASIC_AUTH` (`user:password`). |
